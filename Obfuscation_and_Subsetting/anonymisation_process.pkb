create or replace PACKAGE BODY anonymisation_process is
  ...
  begin
     ...
     exception when others then
        ...
        ut.log(const.k_subsys_obfus,'reset_schema'||to_char(sysdate,'dd-mm-yyyy hh24.mi.ss'),g_code,g_errm,g_module);
...
begin
  begin
    ...
    ut.log(const.k_subsys_obfus,'1: truncate table rnd_derm_adresss_lu',null,null,g_module);

    execute immediate 'truncate table rnd_derm_adresss_lu';

    ut.log(const.k_subsys_obfus,'2: insert into rnd_derm_adresss_lu',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'3: create index rnd_derm_adresss_lu_idx1',null,null,g_module);

    execute immediate 'create index rnd_derm_adresss_lu_idx1 on rnd_derm_adresss_lu(disc_exer_req_mandate_id)';

    ut.log(const.k_subsys_obfus,'4: reset_sequences ns1 and ns2',null,null,g_module);

    ut.reset_sequence(const.k_subsys_obfus,'ns1');
    ut.reset_sequence(const.k_subsys_obfus,'ns2');

    ut.log(const.k_subsys_obfus,'5: truncate table disc_exer_req_mandates_tmp1',null,null,g_module);

    execute immediate 'truncate table disc_exer_req_mandates_tmp1';

    ut.log(const.k_subsys_obfus,'6: insert into disc_exer_req_mandates_tmp1',null,null,g_module);
    ...
    exception
       when others then
          g_code := SQLCODE;
          g_errm := SUBSTR(SQLERRM, 1 , 4000);
          ut.log(const.k_subsys_obfus,substr(DBMS_UTILITY.FORMAT_ERROR_BACKTRACE(),1,4000),g_code,g_errm,g_module);
          RAISE;
  end;
...
begin
  ...
  begin
    ...
    ut.log(const.k_subsys_obfus,'1: truncate table  rnd_adesd_name_lookup',null,null,g_module);
    execute immediate 'truncate table  rnd_adesd_name_lookup';

    ut.log(const.k_subsys_obfus,'2: insert into rnd_adesd_name_lookup',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'3: create index rnd_adesd_name_idx1',null,null,g_module);
...
--    Match on address_type 4 if no match get from seed_address
    ...
    ut.log(const.k_subsys_obfus,'4: truncate table rnd_adesd_adresss_lu',null,null,g_module);
    execute immediate 'truncate table rnd_adesd_adresss_lu';

    ut.log(const.k_subsys_obfus,'5: insert into rnd_adesd_adresss_lu',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'6: create index rnd_adesd_adresss_lu_idx1',null,null,g_module);
    execute immediate 'create index rnd_adesd_adresss_lu_idx1 on rnd_adesd_adresss_lu(discret_exercise_req_id)';

    ut.log(const.k_subsys_obfus,'7: truncate table disc_exer_spouse_dtls_tmp1',null,null,g_module);
    execute immediate 'truncate table disc_exer_spouse_dtls_tmp1';

    ut.log(const.k_subsys_obfus,'8: insert into disc_exer_spouse_dtls_tmp1',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'Executing: ' || v_sql,null,null,g_module);
...
begin
    ...
    ut.log(const.k_subsys_obfus,'1: truncate table  cash_ivc_class_copies_tmp1',null,null,g_module);
    execute immediate 'truncate table cash_ivc_class_copies_tmp1';

    ut.log(const.k_subsys_obfus,'1: insert into cash_ivc_class_copies_tmp1',null,null,g_module);
...
begin
  begin
    ...
    ut.log(const.k_subsys_obfus,'1: truncate table rnd_cpm_adresss_lu',null,null,g_module);

    execute immediate 'truncate table rnd_cpm_adresss_lu';

    ut.log(const.k_subsys_obfus,'2: insert into rnd_cpm_adresss_lu',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'3: drop index rnd_cpm_adresss_lu_idx1',null,null,g_module);
    begin
      execute immediate 'drop index rnd_cpm_adresss_lu_idx1';
      exception when others then null;
    end;

    ut.log(const.k_subsys_obfus,'4: create index rnd_cpm_adresss_lu_idx1',null,null,g_module);
    execute immediate 'create index rnd_cpm_adresss_lu_idx1 on rnd_cpm_adresss_lu(comp_payee_id)';

    ut.log(const.k_subsys_obfus,'5: reset sequences ns1 and ns2',null,null,g_module);
    ut.reset_sequence(const.k_subsys_obfus,'ns1');
    ut.reset_sequence(const.k_subsys_obfus,'ns2');

    ut.log(const.k_subsys_obfus,'6: truncate table comp_payee_mandates_tmp1',null,null,g_module);
    execute immediate 'truncate table comp_payee_mandates_tmp1';

    ut.log(const.k_subsys_obfus,'7: insert into comp_payee_mandates_tmp1',null,null,g_module);
...
begin
  ...
  begin
    ...
    ut.log(const.k_subsys_obfus,'1: truncate table rnd_me_name_lookup',null,null,g_module);

    execute immediate 'truncate table rnd_me_name_lookup';

    ut.log(const.k_subsys_obfus,'2: insert into rnd_me_name_lookup',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'3: drop index rnd_me_name_idx1',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'4: create index rnd_me_name_idx1 on rnd_me_name_lookup(mifid_entity_id)',null,null,g_module);

    execute immediate 'create index rnd_me_name_idx1 on rnd_me_name_lookup(mifid_entity_id)';
--    Match on address_type 4 if no match get from seed_address

    ut.log(const.k_subsys_obfus,'5: truncate table mifid_entities_tmp1',null,null,g_module);

    execute immediate 'truncate table mifid_entities_tmp1';

    ut.log(const.k_subsys_obfus,'6: insert into mifid_entities_tmp1',null,null,g_module);
...
begin
  ...
  begin
    ...
    ut.log(const.k_subsys_obfus,'1: truncate table rnd_mi_name_lookup',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'2: insert into rnd_mi_name_lookup ',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'3: drop index rnd_mi_name_idx1',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'4: create index rnd_mi_name_idx1 on rnd_mi_name_lookup(transaction_detail_id)',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'5: drop index rnd_mi_name_idx2',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'6: create index rnd_mi_name_idx2 on rnd_mi_name_lookup(bulk_trade_id)',null,null,g_module);

    execute immediate 'create index rnd_mi_name_idx2 on rnd_mi_name_lookup(bulk_trade_id)';

    ut.log(const.k_subsys_obfus,'7: truncate table mifid_transaction_details_tmp1',null,null,g_module);

    execute immediate 'truncate table mifid_transaction_details_tmp1';

    ut.log(const.k_subsys_obfus,'8: insert into mifid_transaction_details_tmp1',null,null,g_module);
...
begin
  ...
  begin
    ...
    ut.log(const.k_subsys_obfus,'1: truncate table mifid_bulk_trades_tmp1',null,null,g_module);

    execute immediate 'truncate table mifid_bulk_trades_tmp1';

    ut.log(const.k_subsys_obfus,'2: insert into mifid_bulk_trades_tmp1(bulk_trade_id,ivc_code,holder_surname)',null,null,g_module);
...
begin
    ...
    ut.log(const.k_subsys_obfus,'1: reset sequence ns',null,null,g_module);
    ut.reset_sequence(const.k_subsys_obfus,'ns');

    ut.log(const.k_subsys_obfus,'2: truncate table address_line_1_rnd',null,null,g_module);
    execute immediate 'truncate table address_line_1_rnd';

    ut.log(const.k_subsys_obfus,'3: insert into address_line_1_rnd',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'4: reset sequence ns',null,null,g_module);
    ut.reset_sequence(const.k_subsys_obfus,'ns');

    ut.log(const.k_subsys_obfus,'5: truncate table address_line_2_rnd',null,null,g_module);
    execute immediate 'truncate table address_line_2_rnd';

    ut.log(const.k_subsys_obfus,'6: insert into  address_line_2_rnd',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'7: reset sequence ns',null,null,g_module);
    ut.reset_sequence(const.k_subsys_obfus,'ns');

    ut.log(const.k_subsys_obfus,'8: truncate table address_line_3_rnd',null,null,g_module);
    execute immediate 'truncate table address_line_3_rnd';

    ut.log(const.k_subsys_obfus,'9: insert into address_line_3_rnd',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'10: reset sequence ns',null,null,g_module);
    ut.reset_sequence(const.k_subsys_obfus,'ns');

    ut.log(const.k_subsys_obfus,'11: truncate table postcode_rnd',null,null,g_module);
    execute immediate 'truncate table postcode_rnd';

    ut.log(const.k_subsys_obfus,'12: insert into  postcode_rnd',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'13: create indexes',null,null,g_module);
...
begin
   ...
   ut.log(const.k_subsys_obfus,'reset sequence surname_seq',null,null,g_module);
   ut.reset_sequence(const.k_subsys_obfus,'surname_seq');

   ut.log(const.k_subsys_obfus,'reset sequence forename_seq',null,null,g_module);
   ut.reset_sequence(const.k_subsys_obfus,'forename_seq');
...
begin
  begin
   ...
   ut.log(const.k_subsys_obfus,'reset sequence forename_seq',null,null,g_module);
   ut.reset_sequence(const.k_subsys_obfus,'notes_seq');
      ...
      begin
        ...
        for get_stmt_rec in c_get_stmt loop
          begin
            ...
            --ut.log(const.k_subsys_obfus,substr(get_stmt_rec.stmt,1,4000),g_code,g_errm,g_module);
            commit;
            exception when others then
              g_code := SQLCODE;
              g_errm := SUBSTR(SQLERRM, 1 , 4000);
              ut.log(const.k_subsys_obfus,substr(get_stmt_rec.stmt,1,4000),g_code,g_errm,g_module);
              ut.log(const.k_subsys_obfus,g_module||to_char(sysdate,'dd-mm-yyyy hh24.mi.ss'),g_code,g_errm,g_module);
              g_code := NULL;
              g_errm := NULL;
          end;
        end loop;
...
--        end;
--
--        ut.log(const.k_subsys_obfus,'1: to be implemented',null,null,g_module);
     exception
        when others then
          g_code := SQLCODE;
          g_errm := SUBSTR(SQLERRM, 1 , 4000);
          ut.log(const.k_subsys_obfus,substr(DBMS_UTILITY.FORMAT_ERROR_BACKTRACE(),1,4000),g_code,g_errm,'merge_to_target_manual');
     end;
      ...
      begin
         ...
         for purge_tables_rec in purge_tables(p_prefix ,'\' )  loop
            ...
            exception when others then
               g_code := SQLCODE;
               g_errm := SUBSTR(SQLERRM, 1 , 4000);
               ut.log(const.k_subsys_obfus,'Truncation of '||purge_tables_rec.owner||'.'||purge_tables_rec.table_name|| ' failed',g_code,g_errm,g_module);
...
begin
   begin
      ...
      ut.log(const.k_subsys_obfus,'1: truncate table holder_base',null,null,g_module);
      execute immediate 'truncate table holder_base';

      ut.log(const.k_subsys_obfus,'2: insert into holder_base',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'3: truncate table holders_tmp1',null,null,g_module);
      begin
         execute immediate 'truncate table holders_tmp1';
      exception when others then null;
      end;

      ut.log(const.k_subsys_obfus,'4: insert into holders_tmp1',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'5: Generating Sort_Key',null,null,g_module);

      ut.log(const.k_subsys_obfus,'6: truncate table sk_temp',null,null,g_module);
      begin
        execute immediate 'truncate table sk_temp';
        exception when others then null;
      end;

      ut.log(const.k_subsys_obfus,'7: insert into sk_temp',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'8: drop index sk_temp_12345678',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'9: create index sk_temp_12345678 on sk_temp(comp_code,ivc_code)',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'10: merge into holders_tmp1',null,null,g_module);
  ...
  begin
    begin
      ...
      ut.log(const.k_subsys_obfus,'1: truncate table holder_employee_details_tmp1',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'2: insert into holder_employee_details_tmp1',null,null,g_module);
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'1: truncate table forename_shuffle1',null,null,g_module);
      execute immediate 'truncate table forename_shuffle1';

      ut.log(const.k_subsys_obfus,'2: insert into forename_shuffle1',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'3: truncate table forename_shuffle',null,null,g_module);
      execute immediate 'truncate table forename_shuffle';

      ut.log(const.k_subsys_obfus,'4: insert into forename_shuffle',null,null,g_module);
      ...
      loop
        ...
        ut.log(const.k_subsys_obfus,'5: IN LOOP update forename_shuffle',null,null,g_module);
     ...
     ut.log(const.k_subsys_obfus,'6: truncate table surname_shuffle1',null,null,g_module);
     execute immediate 'truncate table surname_shuffle1';

     ut.log(const.k_subsys_obfus,'7: insert into surname_shuffle1',null,null,g_module);
     ...
     execute immediate 'insert into surname_shuffle1(HOLDER_NAME_ID,comp_code,ivc_code ,holder_seq,
      ...
      ut.log(const.k_subsys_obfus,'8: truncate table surname_shuffle',null,null,g_module);
      execute immediate 'truncate table surname_shuffle';

      ut.log(const.k_subsys_obfus,'9: insert into surname_shuffle',null,null,g_module);
      ...
      loop
        ...
        ut.log(const.k_subsys_obfus,'10: IN LOOP update surname_shuffle',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'11: truncate table holder_names_tmp1',null,null,g_module);
    begin
      execute immediate 'truncate table holder_names_tmp1';
      exception when others then null;
    end;

    ut.log(const.k_subsys_obfus,'12: insert into holder_names_tmp1',null,null,g_module);
  ...
  begin
      ...
      ut.log(const.k_subsys_obfus,'1: truncate holder_labels_tmp tables',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'2: insert into  holder_labels_tmp3',null,null,g_module);
     ...
     'select hn.holder_type_code,hn.other_title,hl.holder_label_id,hl.holder_label_type_code,hl.comp_code,hl.ivc_code,hn.forename,hn.surname,
      ...
      --ut.log(const.k_subsys_obfus,substr('Executing: ' || v_sql),1,4000),null,null,g_module);
      execute immediate v_sql;
      
      ut.log(const.k_subsys_obfus,'2: insert into  holder_labels_tmp2',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'3: insert into  holder_labels_tmp1',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'4: merge into holder_labels_tmp1',null,null,g_module);
...
procedure anon_bank_branches
   is
    ...
    begin
      ...
      ut.log(const.k_subsys_obfus,'1: truncating tables bank_branches_addr_lu2, bank_branches_addr_lu1 ,bank_branches_addr_lu',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'2: insert into bank_branches_addr_lu2',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'3: insert into bank_branches_addr_lu1',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'4: insert into bank_branches_addr_lu',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'5: gather_table_stats bank_branches_addr_lu',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'6: insert into bank_branches_addr_lu_adjust',null,null,g_module);
      ...
      from bank_branches_addr_lu base
        ...
        ut.log(const.k_subsys_obfus,'7: gather_table_stats BANK_BRANCHES_ADDR_LU',null,null,g_module);
        dbms_stats.gather_table_stats(ownname=>g_run_env,tabname =>'BANK_BRANCHES_ADDR_LU',estimate_percent=>100);

        nloopcounter := 0;
        loop
          ut.log(const.k_subsys_obfus,'8: IN LOOP update bank_branches_addr_lu_adjust where resolved = N',null,null,g_module);
          ...
          ut.log(const.k_subsys_obfus,'9: gather_table_stats BANK_BRANCHES_ADDR_LU',null,null,g_module);
          ...
          ut.log(const.k_subsys_obfus,'10: IN LOOP: update bank_branches_addr_lu_adjust set resolved = Y',null,null,g_module);
         ...
         ut.log(const.k_subsys_obfus,'11: IN LOOP: update bank_branches_addr_lu_adjust',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'12: truncate table bank_branches_tmp1',null,null,g_module);
      begin
        execute immediate 'truncate table bank_branches_tmp1';
        exception when others then null;
      end;

      ut.log(const.k_subsys_obfus,'13: insert into bank_branches_tmp1',null,null,g_module);
  ...
  begin
    ...
    ut.log(const.k_subsys_obfus,'1: truncate table rnd_disp_mandate_adresss_lu',null,null,g_module);

    execute immediate 'truncate table rnd_disp_mandate_adresss_lu';

    ut.log(const.k_subsys_obfus,'2: insert into rnd_disp_mandate_adresss_lu',null,null,g_module);
    ...
    ut.log(const.k_subsys_obfus,'3: truncate table holder_mandates_tmp1',null,null,g_module);
    execute immediate 'truncate table holder_mandates_tmp1';

    ut.log(const.k_subsys_obfus,'4: insert into holder_mandates_tmp1',g_code,g_errm,g_module);
...
--
 ...
 procedure anon_payments is
  begin
     ...
     ut.log(const.k_subsys_obfus,'0 - truncate tables payments_base,payments_base_fin,rnd_dispatch_name_lookup,rnd_disp_payment_adresss_lu,rnd_disp_payment_adresss_lu,payments_tmp1',g_code,g_errm,g_module);
     ...
     exception
        when others then
          g_code := SQLCODE;
          g_errm := SUBSTR(SQLERRM, 1 , 4000);
          ut.log(const.k_subsys_obfus,'ERROR: truncate table payments_base.',g_code,g_errm,g_module);
     end;
     ...
     exception
        when others then
          g_code := SQLCODE;
          g_errm := SUBSTR(SQLERRM, 1 , 4000);
          ut.log(const.k_subsys_obfus,'ERROR: truncate table rnd_dispatch_name_lookup.',g_code,g_errm,g_module);
     end;
     ...
     exception
        when others then
          g_code := SQLCODE;
          g_errm := SUBSTR(SQLERRM, 1 , 4000);
          ut.log(const.k_subsys_obfus,'ERROR: truncate table rnd_disp_payment_adresss_lu.',g_code,g_errm,g_module);
     end;
     ...
     exception
        when others then
          g_code := SQLCODE;
          g_errm := SUBSTR(SQLERRM, 1 , 4000);
          ut.log(const.k_subsys_obfus,'ERROR: truncate table payments_tmp1.',g_code,g_errm,g_module);
     end;

     ut.log(const.k_subsys_obfus,'1 - insert into rnd_dispatch_name_lookup',g_code,g_errm,g_module);
     ...
     select payment_id, mod(abs(dbms_random.random),'|| anonymisation_process.g_max_rnd_surname_seq ||') +1 surname_key, 
      ...
      ut.log(const.k_subsys_obfus,'2 - drop and create index rnd_dispatch_name_idx1',g_code,g_errm,g_module);
    begin
...
--    Match on address_type 4 if no match get from seed_address
     ...
     ut.log(const.k_subsys_obfus,'3 - insert into rnd_disp_payment_adresss_lu',g_code,g_errm,g_module);
    ...
    ut.log(const.k_subsys_obfus,'4 - drop and create index rnd_disp_pay_adrr_lu_idx1 on rnd_disp_payment_adresss_lu',g_code,g_errm,g_module);
    ...
    ut.log(const.k_subsys_obfus,'5 - deleting duplicates from holder_labels_tmp1',g_code,g_errm,g_module);
    ...
    ut.log(const.k_subsys_obfus,'6 - deleted ' || sql%rowcount || ' duplicates from holder_labels_tmp1',g_code,g_errm,g_module);

    ut.log(const.k_subsys_obfus,'7 - insert into payments_base',g_code,g_errm,g_module);
    ...
    ut.log(const.k_subsys_obfus,'8 - Refresh stats on table PAYMENTS_BASE',g_code,g_errm,g_module);
    dbms_stats.gather_table_stats(ownname => g_run_env, tabname => 'PAYMENTS_BASE');

    commit;

    ut.log(const.k_subsys_obfus,'10 - insert into payments_tmp1',g_code,g_errm,g_module);
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'1: create index idx_rcrr1 on tgt_rr556_cnb_reversal_report',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'2: merge into tgt_rr556_cnb_reversal_report',null,null,g_module);
...
/*
  ...
  procedure merge_rr556_cnb_bank_reversal
   ...
   begin
         ...
         ut.log(const.k_subsys_obfus,'1: merge into tgt_rr556_cnb_bank_reversal_to tgt',g_code,g_errm,g_module);
...
--         ut.log(const.k_subsys_obfus,'2: create index idx_rcbrt',g_code,g_errm,g_module);
...
*/
  ...
  procedure merge_crest_participants
   ...
   begin
         ...
         ut.log(const.k_subsys_obfus,'1: merge into tgt_crest_participants',g_code,g_errm,g_module);
  ...
  procedure merge_fatca_clsf_extracts
   ...
   begin
         ...
         ut.log(const.k_subsys_obfus,'1: merge into tgt_fatca_clsf_extracts',g_code,g_errm,g_module);
  ...
  begin
     begin
        ...
        ut.log(const.k_subsys_obfus,'Partition ' || p_partition_name || ': Executing tgt_CASH_TRANSACTION update: ' || v_sql,null,null,g_module);                                                        
        execute immediate v_sql;
  
        v_update_count := SQL%ROWCOUNT;

        ut.log(const.k_subsys_obfus,to_char(v_update_count) || ' tgt_CASH_TRANSACTION records updated in partition ' || p_partition_name,null,null,g_module); 
     ...
     exception when others then
        g_code := SQLCODE;
        g_errm := SUBSTR(SQLERRM, 1 , 4000);
        ut.log(const.k_subsys_obfus,v_sql,g_code,g_errm,g_module);        
     end;                     
   ...
   begin
       ...
       -- partition_update_counts truncated by obfuscation_control.truncate_report_tables on creation of new obfus_run_id
         ...
         loop -- JOB CREATION LOOP
           ...
           loop
             ...
             then
               ut.sleep(const.k_subsys_obfus,const.k_sleep_seconds);              
               ut.log(const.k_subsys_obfus,'3: opening c_running_jobs with job_category: '||v_job_category||' and start_date '|| to_char(v_start_date,'dd-mon-yyyy hh24:mi:ss'),null,null,g_module);
               open c_running_jobs(v_job_category,v_start_date);
               fetch c_running_jobs into v_running_job_count;
               close c_running_jobs;
               ut.log(const.k_subsys_obfus,'v_running_job_count = '||to_char(v_running_job_count),null,null,g_module);               
             end if;  
             
             if v_running_job_count > const.k_max_parallel_jobs 
             then
               ut.log(const.k_subsys_obfus,'4: Running job count '||to_char(v_running_job_count)||' exceeds const.k_max_parallel_jobs, so continuing to next iteration after sleep of ' || to_char(const.k_sleep_seconds),null,null,g_module);
               ut.sleep(const.k_subsys_obfus,const.k_sleep_seconds);
               continue;
             else   
             
               if p_table_name = 'CASH_TRANSACTIONS' then
                 ut.log(const.k_subsys_obfus,'5: Creating DBMS_SCHEDULER job update_tgt_CASH_TRANSACTIONS_'|| r.partition_name,null,null,g_module);                                                        
                 ...
                 ut.log(const.k_subsys_obfus,'5: Creating DBMS_SCHEDULER job MERGE_PAYMENTS_'|| r.partition_name,null,null,g_module);                                                        
               ...
               ut.log(const.k_subsys_obfus,'v_job_action: '|| v_job_action,null,null,g_module);
               --dbms_output.put_line(v_job_action);
               ut.log(const.k_subsys_obfus,'v_job_name: '|| v_job_name,null,null,g_module);           
               --dbms_output.put_line(v_job_name); 

               ut.create_job ( const.k_subsys_obfus,v_job_name,v_job_action,'PLSQL_BLOCK',null,v_comments );
   
               ut.merge_job_execution(const.k_subsys_obfus, gp.obfus_run_id, v_job_name, gp.get_obfus_execution_id); 
           ...
           ut.log(const.k_subsys_obfus,'v_counter: '|| to_char(v_counter),null,null,g_module);            
         ...
         begin
            loop
               v_incomplete_job_cnt := ut.get_incomplete_job_cnt (const.k_subsys_obfus, gp.obfus_run_id, v_start_date);
               exit when v_incomplete_job_cnt = 0;
               ut.sleep(const.k_subsys_obfus,const.k_sleep_seconds);   
            end loop;         
         ...
         ut.log(const.k_subsys_obfus,'Successfully completed update of ' || to_char(v_total_update_count) ||' '|| p_table_name || ' records in parallel by partition.',null,null,g_module);   

         if gp.bln_stop_job_overrun
         then
            ut.drop_overrun_prevention_jobs(const.k_subsys_obfus);
         end if;        
      ...
      exception            
         when others then
           g_code := SQLCODE;
           g_errm := SUBSTR(SQLERRM, 1 , 4000);
           ut.log(const.k_subsys_obfus,DBMS_UTILITY.FORMAT_ERROR_BACKTRACE(),g_code,g_errm,g_module);
           RAISE;
      end;
  ...
  is
   ...
   begin
      begin
         ...
         ut.log(const.k_subsys_obfus,'1: fetching partition_update_seq.nextval '||to_char(sysdate,'dd-mm-yyyy hh24.mi.ss'),null,null,g_module);

         select partition_update_seq.nextval
          into v_part_update_seq
          from dual;

         ut.log(const.k_subsys_obfus,'2: gather_table_stats for RANDOMISED_NOTES '||to_char(sysdate,'dd-mm-yyyy hh24.mi.ss'),null,null,g_module);

         begin
            dbms_stats.gather_table_stats(ownname=>g_run_env, tabname=>'RANDOMISED_NOTES', cascade=>true);
         end;

         ut.log(const.k_subsys_obfus,'3: updating tgt_cash_transactions.comment_text '||to_char(sysdate,'dd-mm-yyyy hh24.mi.ss'),null,null,g_module);
  ...
  procedure merge_ideal_trans
   ...
   begin
         ...
         ut.log(const.k_subsys_obfus,'1: merge into TGT_IDEAL_TRANS',g_code,g_errm,g_module);
  ...
  procedure merge_money_launder_ctls
   ...
   begin
        ...
        ut.log(const.k_subsys_obfus,'11: merge into TGT_MONEY_LAUNDER_CTLS',g_code,g_errm,g_module);
  ...
  procedure merge_holders
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'1: disable HOLDERS_BRIUD trigger',null,null,g_module);
      execute immediate 'ALTER TRIGGER '||g_tgt_prefix||'_PRISM_CORE.HOLDERS_BRIUD disable';
      --
      ut.log(const.k_subsys_obfus,'2: merge into tgt_holders',null,null,g_module);
      ...
      ut.log(const.k_subsys_obfus,'3: enable HOLDERS_BRIUD trigger',null,null,g_module);
...
procedure merge_holder_names
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_holder_names',null,null,g_module);
  ...
  procedure merge_bank_branches
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_bank_branches',null,null,g_module);
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_holder_addresses',null,null,g_module);
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_holder_employee_details',null,null,g_module);
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_holder_labels',null,null,g_module);
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_holder_mandates',null,null,g_module);
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_disc_exer_req_mandates',null,null,g_module);
  ...
  procedure merge_disc_exer_spouse_dtls
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_disc_exer_spouse_dtls',null,null,g_module);
  ...
  procedure merge_mifid_entities
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_mifid_entities',null,null,g_module);
  ...
  procedure merge_cash_ivc_class_copies
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_cash_ivc_class_copies',null,null,g_module);
  ...
  begin
     ...
     ut.log(const.k_subsys_obfus,'merge into tgt_comp_payee_mandates',null,null,g_module);
  ...
  exception when others then
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_mifid_transaction_details',null,null,g_module);
  ...
  begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_mifid_bulk_trades',null,null,g_module);
  ...
  exception when others then
   ...
   begin
      ...
      ut.log(const.k_subsys_obfus,'merge into tgt_cheque_ranges',null,null,g_module);
  ...
  begin
     ...
     ut.log(const.k_subsys_obfus,'merge into tgt_payments('||p_partition_name||')',null,null,g_module);
     ...
     v_sql := 'merge into tgt_payments partition('||p_partition_name||') tp ' ||
      ...
      ut.log(const.k_subsys_obfus,'Executing tgt_payments merge for partition: '||p_partition_name||' sql: '||v_sql,null,null,g_module);                                                        
      execute immediate v_sql;
  
      v_update_count := SQL%ROWCOUNT;

      ut.log(const.k_subsys_obfus,'Updated ' || to_char(v_update_count) || ' payments records in partition ' || p_partition_name,null,null,g_module); 
...
--      anonymisation_process.ut.log(const.k_subsys_obfus,'Executing: ' || v_sql,null,null,g_module);
--      execute immediate v_sql;
--      
...
--      execute immediate v_sql;
--
--      anonymisation_process.ut.log(const.k_subsys_obfus,SQL%ROWCOUNT || ' rows inserted into '||g_tgt_prefix||'_PRISM_CORE.SIP_CASH_RECON_TEMP: ' || v_sql,null,null,g_module);
--       
--       
--      exception when others then
--          g_code := SQLCODE;
--          g_errm := SUBSTR(SQLERRM, 1 , 4000);
--          ut.log(const.k_subsys_obfus,'Error inserting into '||g_tgt_prefix||'_PRISM_CORE.SIP_CASH_RECON_TEMP: ' || v_sql,g_code,g_errm,g_module);
--          raise;
--    end;
    ...
    exception when others then
       g_code := SQLCODE;
       g_errm := SUBSTR(SQLERRM, 1 , 4000);
       ut.log(const.k_subsys_obfus,'Error merging into tgt_EMPLOYING_COMP_TAX_DETAILS',g_code,g_errm,g_module);
       raise;
    end;     
...
--
  ...
  begin
     ...
     g_module := 'generate_table_qa_reports'; 
      ...
      ut.log(const.k_subsys_obfus,'Re-populating qa_results_tmp for owner ' || p_owner ||' and table_name = ' || p_table_name,null,null,g_module);
      delete from  qa_results_tmp where owner = p_owner and table_name = p_table_name;
          
      ut.log(const.k_subsys_obfus,'Processing cursor c_get_stmt',null,null,g_module);           
      for get_stmt_rec in c_get_stmt(p_owner,p_table_name,p_src_prefix,p_anon_version) loop
        ...
        --  anonymisation_process.ut.log(const.k_subsys_obfus,'Executing stmt ' || get_stmt_rec.stmt,null,null,g_module);
       ...
       -- anonymisation_process.ut.log(const.k_subsys_obfus,'insert into qa_results_tmp for owner ' || p_owner ||' and table_name = ' || p_table_name,null,null,g_module);        
      ...
      ut.log(const.k_subsys_obfus,'Processing cursor c_get_stmt2 for PC_Scope_Missing',null,null,g_module);       
      ...
      ut.log(const.k_subsys_obfus,'Processing cursor c_get_stmt3 for Missing_From_PC',null,null,g_module); 
      ...
      ut.log(const.k_subsys_obfus,'Processing cursor c_get_stmt4 for Stereo_Type_Mismatch',null,null,g_module); 
      ...
      ut.log(const.k_subsys_obfus,'Re-populating qa_results_pivot for owner ' || p_owner ||' and table_name = ' || p_table_name,null,null,g_module);        
      ...
      ut.log(const.k_subsys_obfus,'Updating qa_results_pivot for owner ' || p_owner ||' and table_name = ' || p_table_name,null,null,g_module);      
  ...
  begin
     ...
     begin
        ...
        If p_prepost_anomolies = 1 then    
           ut.log(const.k_subsys_obfus,'Deleting stats_results_1 for owner ' || p_owner ||' and table_name = ' || p_table_name,null,null,g_module);
           delete stats_results_1 where owner = p_owner and table_name = p_table_name;  
        elsif  p_prepost_anomolies = 2 then   
           ut.log(const.k_subsys_obfus,'Deleting stats_results_2 for owner ' || p_owner ||' and table_name = ' || p_table_name,null,null,g_module);
           delete stats_results_2 where owner = p_owner and table_name = p_table_name;        
        end if;
             
        for r in c_get_stmt 
        loop
           ut.log(const.k_subsys_obfus,'Executing: '||r.stmt,null,null,g_module);      
           execute immediate r.stmt INTO stat_type_rec;
           
           If p_prepost_anomolies = 1 then
           
             ut.log(const.k_subsys_obfus,'Inserting stats_results_1',null,null,g_module);
             ...
             ut.log(const.k_subsys_obfus,'Inserting stats_results_2',null,null,g_module);
      ...
      begin
        ...
        loop
            for get_stmt_rec in c_get_stmt loop
              ...
              begin
                  ut.log(const.k_subsys_obfus,substr('Pass : '||to_char(v_nCounter)|| 'Executing : '|| get_stmt_rec.stmt,1,4000),null,null,g_module);
                  execute immediate get_stmt_rec.stmt;
                  ut.log(const.k_subsys_obfus,'Pass : '||to_char(v_nCounter)||' Complete : ' ||to_char(sql%rowcount) ||' merged.',null,null,g_module);
                  
                  --dbms_output.put_line( get_stmt_rec.stmt);
                  commit;
                exception when others then
                  ut.log(const.k_subsys_obfus,substr(get_stmt_rec.stmt,1,4000),sqlcode,substr(sqlerrm,1,4000),g_module);
                  RAISE;
              end;
...
begin
  ...
  for cCreMaskColsRec in cCreMaskCols(p_owner,p_table_name) loop
     begin
        ut.log(const.k_subsys_obfus,substr('Executing : '||cCreMaskColsRec.stmt,1,4000),null,null,g_module);
        execute immediate cCreMaskColsRec.stmt;
     exception 
        when others then 
            g_code := SQLCODE;
            g_errm := SUBSTR(SQLERRM, 1 ,4000);   
            ut.log(const.k_subsys_obfus,'Error  cCreMaskColsRec.stmt: '|| cCreMaskColsRec.stmt,g_code,g_errm,g_module);      
     end;
  end loop;

  for cRenameUnusedRec in cRenameUnused(p_owner,p_table_name) loop
     begin
        ut.log(const.k_subsys_obfus,substr('Executing : '||cRenameUnusedRec.stmt,1,4000),null,null,g_module);
        execute immediate cRenameUnusedRec.stmt;
     exception 
        when others then 
            g_code := SQLCODE;
            g_errm := SUBSTR(SQLERRM, 1 ,4000);   
            ut.log(const.k_subsys_obfus,'Error  cRenameUnusedRec.stmt: '|| cRenameUnusedRec.stmt,g_code,g_errm,g_module);         
     end;
  end loop;
  
  for cSetUnusedRec in cSetUnused(p_owner,p_table_name) loop
     begin
        ut.log(const.k_subsys_obfus,substr('Executing : '||cSetUnusedRec.stmt,1,4000),null,null,g_module);
        execute immediate cSetUnusedRec.stmt;
     exception 
        when others then 
            g_code := SQLCODE;
            g_errm := SUBSTR(SQLERRM, 1 ,4000);   
            ut.log(const.k_subsys_obfus,'Error  cSetUnusedRec.stmt: '|| cSetUnusedRec.stmt,g_code,g_errm,g_module);         
     end;        
  end loop;
  
--  v_sStmt := 'alter table '||g_tgt_prefix||'_'||p_owner||'.'||p_table_name|| ' drop unused columns';
--  ut.log(const.k_subsys_obfus,substr('Executing : '||v_sStmt,1,4000),null,null,g_module);
--  execute immediate v_sStmt;
  
  for cRenameRec in cRename(p_owner,p_table_name) loop
     begin  
        ut.log(const.k_subsys_obfus,substr('Executing : '||cRenameRec.stmt,1,4000),null,null,g_module);
        execute immediate cRenameRec.stmt;
     exception 
        when others then 
            g_code := SQLCODE;
            g_errm := SUBSTR(SQLERRM, 1 ,4000);   
            ut.log(const.k_subsys_obfus,'Error  cRenameRec.stmt: '|| cRenameRec.stmt,g_code,g_errm,g_module);         
     end;       
  end loop;
  
  for cDropDefaultRec in cDropDefault(p_owner,p_table_name) loop
     begin   
        ut.log(const.k_subsys_obfus,substr('Executing : '||cDropDefaultRec.stmt,1,4000),null,null,g_module);
        execute immediate cDropDefaultRec.stmt;
     exception 
        when others then 
            g_code := SQLCODE;
            g_errm := SUBSTR(SQLERRM, 1 ,4000);   
            ut.log(const.k_subsys_obfus,'Error  cDropDefaultRec.stmt: '|| cDropDefaultRec.stmt,g_code,g_errm,g_module);         
     end;       
  end loop;
  ...
  begin
    ...
    loop
      begin
        ut.log(const.k_subsys_obfus,substr('Executing : '||r.constraint_ddl,1,4000),null,null,g_module);
        execute immediate r.constraint_ddl;
      exception
        when others then
          g_code := SQLCODE;
          g_errm := SUBSTR(SQLERRM, 1 , 4000);        
          ut.log(const.k_subsys_obfus,'Error creating constraint for ' || p_owner||'.'|| p_table_name,g_code,g_errm,g_module);
      end;
    end loop;
  end;
  ...
  begin
    ...
    loop
      begin
        ut.log(const.k_subsys_obfus,substr('Executing : '||r.index_ddl,1,4000),null,null,g_module);
        ...
        when excep.x_object_name_already_used then
          ...
          exception
            when others then
              g_code := SQLCODE;
              g_errm := SUBSTR(SQLERRM, 1 ,4000);   
              ut.log(const.k_subsys_obfus,'Error rebuilding index : '||r.index_name,g_code,g_errm,g_module);
          end;
        when others then
          --e.g. ORA-01452: cannot CREATE UNIQUE INDEX; duplicate keys found
          g_code := SQLCODE;
          g_errm := SUBSTR(SQLERRM, 1 , 4000);        
          ut.log(const.k_subsys_obfus,'Error building index',g_code,g_errm,g_module);
      end;
    end loop;
  end;
